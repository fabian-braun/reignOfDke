...
public class Debug {
	...
	//
	// private static String[] currentIndicatorStrings = new
	// String[GameConstants.NUMBER_OF_INDICATOR_STRINGS];
	//
	...
	// }
	//
	// public static void indicate(String debugSet, int indicator, String
	// message) {
	// if (debugSet == activeDebugSet) {
	// rc.setIndicatorString(indicator, String.format("turn %d: %s",
	// Clock.getRoundNum(), message));
	// currentIndicatorStrings[indicator] = message;
	// }
	// }
	//
	// public static void indicateAppend(String debugSet, int indicator, String
	// message) {
	// indicate(debugSet, indicator, currentIndicatorStrings[indicator] +
	// message);
	// }
	//
	...
	//
	// int totalBytecodes = GameConstants.BYTECODE_LIMIT * (timerEndRoundNum -
	// timerStartRoundNum) + (timerEndBytecodeNum - timerStartBytecodeNum);
	//
	// System.out.println(String.format("timed %s: took %d bytecodes ( = %f turns)\n",
	// message, totalBytecodes, totalBytecodes / (double)
	...
	// Debug.indicateAppend("bytecodes", 0, message + ": " +
